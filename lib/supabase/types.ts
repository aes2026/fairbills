    ...
    Tables: {
      bill_submissions: {
        Row: {
          ...
          created_at: string;
          email: string | null;
          ev_tariff_kwh: number | null;
          ev_tariff_present: boolean | null;
          ...
          solar_export_present: boolean | null;
          solar_fit_cents_per_kwh: number | null;
          super_off_peak_kwh: number | null;
          super_off_peak_present: boolean | null;
