...
export async function POST(req: Request) {
  ...
  const bill: ParsedBill = {
    ...
    ev_tariff_present: false,
    ev_tariff_kwh: null,
    ev_tariff_rate_cents: null,
    ev_tariff_window_description: null,
    super_off_peak_present: false,
    super_off_peak_kwh: null,
    super_off_peak_rate_cents: null,
    super_off_peak_window_description: null,
    controlled_load_present: false,
    controlled_load_kwh: null,
    controlled_load_rate_cents: null,
    solar_export_present: false,
